...
class Category extends BaseController {
    ...
    public function create(){
        ...
        if($this->validate('categories')){
            ...
            return redirect()->to("/dashboard/category/$id/edit")->with('message', 'Película creada con éxito.');
    ...
    public function update($id = null){
        ...
        if($this->validate('categories')){
            ...
            return redirect()->to('/dashboard/category')->with('message', 'Película editada con éxito.');
    ...
    public function delete($id = null){
        ...
        return redirect()->to('/dashboard/category')->with('message', 'cateogría eliminada con éxito.');
    }
